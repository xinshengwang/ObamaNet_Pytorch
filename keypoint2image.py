...
def parse_args():
    ...
    parser.add_argument('--testroot',default='output/aud2kyp/real_fake')
    parser.add_argument('--train',default=True,type=bool)
    parser.add_argument('--exp_dir', default='output/kyp2img', 
                        help='path to save')
    parser.add_argument('--run_ID',default='02_40_20_45')
    ...
    parser.add_argument('--max_epochs',default=40)
    parser.add_argument('--lrd_start',default=20)
    parser.add_argument('--lr_decay',type=int,default=45,help='after lr_decay epochs the learning rate decreases to zero')
...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        dataset_test = k2i_data(args.dataroot,split='test')
